...
public class Java_JDBC {  
    ...
    public static Connection getConnectionWithSqlJdbc() throws Exception 
    {
        ...
        String port ="1433";
        String IP = "127.0.0.1";
        String ServerName ="LAPTOP-O852JI22";
        String DBName ="School";
        String driverClass = "com.microsoft.sqlserver.jdbc.SQLServerDriver";
        
        String dbURL = "jdbc:sqlserver://LAPTOP-O852JI22;databaseName=School;encrypt=false;trustServerCertificate=false;loginTimeout=30"; 
